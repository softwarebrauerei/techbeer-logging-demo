...
Level logLevel =  Level.toLevel(System.getenv('LOG_LEVEL') ?: System.getProperty('log.level'), Level.WARN)
...
logger('ch.qos.logback.classic.*', ERROR, ['STDOUT','ROLLING_FILE'], false)

//logger for default package
logger('ch.sobr.techbeer.logging', INFO, ['STDOUT','ROLLING_FILE'], false)
